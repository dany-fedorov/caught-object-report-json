  ...
  test('constants', () => {
    expect({
      ...
      Object {
        ...
        "CORJ_FULL_REPORT_ARRAY_JSON_SCHEMA_LINK": "https://raw.githubusercontent.com/dany-fedorov/caught-object-report-json/main/schema-versions/corj/v0.15-full/report-array.json",
        "CORJ_FULL_REPORT_OBJECT_JSON_SCHEMA_LINK": "https://raw.githubusercontent.com/dany-fedorov/caught-object-report-json/main/schema-versions/corj/v0.15-full/report-object.json",
        "CORJ_REPORT_ARRAY_JSON_SCHEMA_LINK": "https://raw.githubusercontent.com/dany-fedorov/caught-object-report-json/main/schema-versions/corj/v0.15/report-array.json",
        "CORJ_REPORT_OBJECT_JSON_SCHEMA_LINK": "https://raw.githubusercontent.com/dany-fedorov/caught-object-report-json/main/schema-versions/corj/v0.15/report-object.json",
        "CORJ_TRUNCATED_MARKER": "[truncated]",
        "CORJ_VERSION": "corj/v0.15",
        "CORJ_VERSION_FULL": "corj/v0.15-full",
      }
    `);
  });
